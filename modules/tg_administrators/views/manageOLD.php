...
<script>
    ...
    function submitDelete() {
        ...
        var apiUrl = '<?= BASE_URL ?>api/delete/tg_administrators/' + targetRecordId;
    ...
    function drawRecordsTbl(records) {
        ...
        for (var i = 0; i < records.length; i++) {
            ...
            htmlStr+= '<td>' + records[i]['tg_user_id'] + '</td>';
    ...
    function fetchRecords() {
        var apiUrl = '<?= BASE_URL ?>api/get/tg_administrators/?orderBy=username';
        const http = new XMLHttpRequest()
    ...
    function submitCreateRecord(username, password) {
        ...
        var apiUrl = '<?= BASE_URL ?>api/create/tg_administrators';
        const http = new XMLHttpRequest()
    ...
    function submitUpdateRecord(username, password) {
        ...
        var apiUrl = '<?= BASE_URL ?>api/update/tg_administrators/' + targetRecordId;
        const http = new XMLHttpRequest()
