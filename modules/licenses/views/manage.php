...
echo '<p>'.anchor('licenses/create', 'Create New License Record', $btn_attr).'</p>'; 
...
if (count($rows)>0) { ?>
    <table id="results-tbl">
        <thead>
            <tr>
                <th colspan="2">
                    <div>
                        ...
                        echo form_open('licenses/manage/1/', $form_attr); 
            ...
            <tr>
                <th>License Number</th>                <th style="width: 20px;">Action</th>            
            </tr>
        </thead>
        <tbody>
            <?php 
            ...
            <tr>
                ...
                <td><?= anchor('licenses/show/'.$row->id, 'View', $attr) ?></td>        
            </tr>
            <?php
            }
            ?>
