...
<div class="card">
    ...
    <div class="card-body">
        <a href="<?= BASE_URL ?>messages/manage"><button class="alt" id="view-all-btn">View All Messages</button></a>
        <a href="<?= BASE_URL ?>messages/create/<?= $update_id ?>"><button id="update-btn">Update Details</button></a>
...
<div class="two-col">
    <div class="card record-details">
        ...
        <div class="card-body">
            <div><span>Date Created</span><span><?= $date_created ?></span></div>
            <div><span>Sent From</span><span><?= $sent_from ?></span></div>
            <div><span>Sent To</span><span><?= $sent_to ?></span></div>
            <div><span>Message Subject</span><span><?= $message_subject ?></span></div>
            <div><span>Message Body</span><span><?= $message_body ?></span></div>
            <div><span>Opened</span><span><?= $opened ?></span></div>
            <div><span>Code</span><span><?= $code ?></span></div>
            <div><span>From Admin</span><span><?= $from_admin ?></span></div>
        </div>
    </div>
    <div class="card">
        <div class="card-heading">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        ...
        <p>Are you sure?</p>
        <p>You are about to delete a messages record. This cannot be undone.  
