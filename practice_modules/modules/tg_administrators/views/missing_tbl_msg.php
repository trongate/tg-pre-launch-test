<div class="row">
    ...
    <div id="logout">
        <?= anchor('tg_administrators/logout', 'Logout') ?> <span style="font-size: 1.2em;">&#8594;</span>
    </div>
        ...
        <p>
            Trongate 1.3 and higher requires a database table called tg_administrators, with at least 
        ...
        <ul>
        <li>STEP 1: make sure you have a table called 'tg_user_levels' on your database.</li>
        <li>STEP 2: make sure you have a 'tg_user_levels' module in your 'modules' directory.</li>
        <li>STEP 3: make sure you AT LEAST ONE RECORD on 'tg_user_levels' with an ID of 1 (the default level_title is 'admin')</li>
        <li>STEP 4: make sure you have a table called 'tg_users' on your database.</li>
        <li>STEP 5: make sure you have a 'tg_users' module in your 'modules' directory.</li>
        <li>STEP 6: INSERT ONE RECORD into trongate users with a user_level_id of 1, if you don't already have one.</li>
        <li>STEP 7: Take a note of lowest 'id' from tg_users where the user_level_id equals 1.</li>
        ...
        <p>
            <textarea class="u-full-width" style="color: black; min-height: 360px;">CREATE TABLE `tg_administrators` (
  `id` int(11) NOT NULL,
  `username` varchar(65) NOT NULL,
  `password` varchar(60) NOT NULL,
  `tg_user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
INSERT INTO `tg_administrators` (`id`, `username`, `password`, `tg_user_id`) VALUES
('', 'admin', '$2y$11$u/nkfnoy35OfUugThcM59e4LQwruelWt1gxkiVhfVX2ouy6UnIWV6', xxxx);
ALTER TABLE `tg_administrators`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `tg_administrators`
