...
echo '<p>'.anchor('laptops/create', 'Create New Laptop Record', $btn_attr).'</p>'; 
...
if (count($rows)>0) { ?>
    <table id="results-tbl">
        <thead>
            <tr>
                <th colspan="2">
                    <div>
                        ...
                        echo form_open('laptops/manage/1/', $form_attr); 
            ...
            <tr>
                <th>Laptop Title</th>                <th style="width: 20px;">Action</th>            
            </tr>
        </thead>
        <tbody>
            <?php 
            ...
            <tr>
                ...
                <td><?= anchor('laptops/show/'.$row->id, 'View', $attr) ?></td>        
            </tr>
            <?php
            }
            ?>
