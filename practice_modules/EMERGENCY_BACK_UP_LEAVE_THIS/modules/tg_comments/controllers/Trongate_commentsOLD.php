    ...
    function submit() {
        ...
        if ($token_obj == false) {
            ...
            if (isset($information->tables)) {
                ...
                if (isset($tables['tg_comments'])) {
                    $table_permissions = $tables['tg_comments'];

                    if (($table_permissions == '*') || ($table_permissions == 'w')) {
                        //we have permission to insert this comment - let's do it!
                        $this->model->insert($data, 'tg_comments');
        ...
        if ($token_obj == false) {
            ...
            if (isset($information->tables)) {
                ...
                if (isset($tables['tg_comments'])) {
                    ...
                    $sql = 'select * from tg_comments where target_table = :target_table and update_id = :update_id order by date_created';
