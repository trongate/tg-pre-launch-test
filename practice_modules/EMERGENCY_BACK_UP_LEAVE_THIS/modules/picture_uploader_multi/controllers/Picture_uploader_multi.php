...
class Picture_uploader_multi extends Trongate {
    ...
    function _draw_summary_panel($update_id, $uploader_settings) {
        ...
        $data['token'] = $this->tg_security->_make_sure_allowed();
    ...
    function uploader() {
        ...
        $settings = $this->$target_module->_init_picture_uploader_multi_settings();
        ...
        $additional_includes_top[] = BASE_URL.'picture_uploader_multi_module/css/trongate-dropzone.css';
        $data['additional_includes_top'] = $additional_includes_top;
        $additional_includes_btm[] = BASE_URL.'picture_uploader_multi_module/js/trongate-dropzone.js';
        ...
        $data['upload_url'] = BASE_URL.'picture_uploader_multi/upload/'.$target_module.'/'.$update_id;
        $data['delete_url'] = BASE_URL.'picture_uploader_multi/ditch';
